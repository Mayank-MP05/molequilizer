const bohrModelUpdator = (atomicNo = 1, destroy = false) => {
  ...
  if (!isMobile) {
    ...
    $("#periodic-container").append(
      "<div class='col-sm-12'><h2 class='subdued'> (Tap the atom to generate a new one) </h2></div>"
    );
    $("#periodic-container").append(
      `<div class=\'col-sm-12 element-container\' id='bohr-container-1'></div>`
    );
    ...
    var newAtom = new Atom(atomConfig);
    $("#periodic-container").append(
      `<div class='col-sm-12'><h1 class=\'element-name\'></h1></div>`
    );
